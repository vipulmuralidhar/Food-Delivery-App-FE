 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t vipskuttu/food-delivery-app-fe:${VERSION} .'
          sh 'docker push vipskuttu/food-delivery-app-fe:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
       ...
       sh '''
          sed -i "s/image:.*/image: vipskuttu\\/food-delivery-app-fe:${VERSION}/" aws/angular-manifest.yml
        '''
